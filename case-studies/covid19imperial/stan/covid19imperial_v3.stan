...
transformed parameters {
  ...
  lprior[1] = exponential_lpdf(tau | 0.03);
  lprior[2] = normal_lpdf(phi | 0, 5);
  lprior[3] = normal_lpdf(kappa | 0, 0.5);
...
model {
  ...
  target += gamma_lpdf(alpha_hier | 0.1667, 1);
  target += normal_lpdf(ifr_noise | 1, 0.1);
